...
/**
 * #183's before/after bench lives in `streamState.bench.test.ts` — the name
 * puts it in `scripts/gate.sh`'s timing set, so it runs alone rather than in
 * all four copies of the 4x load probe. The identity and growth-shape laws
 * moved with it; nothing was dropped.
 */
