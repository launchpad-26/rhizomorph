 ...
 * `claude -p "<marker>"` command line and asserts it appears in no emitted
 * event — and asserts a `process.seen` WAS emitted in the same run, because a
 * marker test over an empty list passes for the wrong reason.
 *
