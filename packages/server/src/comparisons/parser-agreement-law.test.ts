 ...
 * here and by its counterpart, `packages/web/src/lab/compare/parser-
 ...
 * relative path, the way `packages/web/src/lab/floor-agreement-law.test.ts`
 * already reaches across a package boundary without a cross-package import.
 *
...
describe('the server parser agrees with the shared comparison-artifact fixtures', () => {
