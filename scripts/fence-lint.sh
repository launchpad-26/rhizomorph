...
for n in "$@"; do
  ...
  # spellings were added: they newly drop 5 lines across #104, #130, #132, #214
  # and #343, and every backticked token on those lines is itself a prohibited
  # path. Zero collateral.
  #
