...
YOUR ISSUE — #36 (36. CLI + dispatch wiring: --extra-sessions, rhizomorph env, live lane-attr verify)
...
- `rhizomorph env <lane>` subcommand printing the exact env block a lane (or
...
- Add those env vars to this repo's `.workmux.yaml` so future lanes emit
  telemetry to the local Rhizomorph automatically.
