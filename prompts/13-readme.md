...
YOUR ISSUE — #13 (13. README + demo script)

**Fence (may touch ONLY):** `README.md`, `docs/demo.md`
**Blocked by:** nothing hard (best after spine merges). **Model:** haiku/sonnet. **Wave:** any

README: what the Observatory is (one paragraph from vision), quickstart (install, `observatory`, browser), architecture sketch pointer to docs/. `docs/demo.md`: the end-of-day demo script — live view of this repo's swarm, then the birth replay.

**DoD:** accurate against the merged reality at time of writing; green root gates untouched; fence respected; summary at end.
