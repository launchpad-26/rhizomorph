...
| [0046](0046-the-instrument-spawns-the-operators-own-tools-as-an-explicit-act.md) | The instrument may spawn the operator's own tools as an explicit act; it never holds or forwards a credential; a spawned tool's egress is the operator's, declared on the control that invokes it | 2026-09-10 | accepted (prd-55 ruling 1, recorded on the build #412) |
