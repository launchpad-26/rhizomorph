...
- **prd9 — the trace era** (`docs/prd9.md`, shipped): the one-week handover
  ...
  for the walkthrough.
- **prd10 — the gorgeous round** (`docs/prd10.md`, shipped): a scene-beauty
...
- **prd11 — the causal record** (`docs/prd11.md`, shipped): provenance at
  ...
  built here.
- **prd12 — the laboratory** (`docs/prd12.md`, shipped): the read-only
...
- **prd13 — the TIDE** (`docs/prd13.md`, shipped, cut down from its first
...
- **prd14 — the experiment console** (`docs/prd14.md`, BLESSED 2026-08-06,
  ...
  assume a resolution.**
- **prd15 — the anywhere instrument** (`docs/prd15.md`, BLESSED 2026-08-05,
  ...
  decision.
- **prd16 — the session is a thing you can hold** (`docs/prd16.md`,
...
- **prd17 — the complete record** (`docs/prd17.md`, BLESSED 2026-08-06,
...
- **LiteLLM/OpenRouter/pi capture** — CLIs without native OTel; prd9 ruling 9
  ...
  since prd15: ruling 3 (`docs/prd15.md`) already rules the adapter contract
