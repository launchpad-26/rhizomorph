...
prd3 [ruling 25](prds/done/prd-03-viz-design-study.md) defines the demo as four falsifiable checks, not a
...
Every check below is now run against [prd4 ruling 1](prds/done/prd-04-human-facing.md), the **layman
...
> 1](prds/done/prd-04-human-facing.md)'s layman bar, a non-Lachlan, first-time viewer explicitly
...
graft g6](prds/done/prd-03-viz-design-study.md)); or the fixture showing a count other than five.

## Check 3 — SCENE

> "A first-time viewer explains the encoding within 30 seconds, no legend." —
> [prd4 ruling 1](prds/done/prd-04-human-facing.md) requires this viewer be a genuine layman, not
...
ruling 1](prds/done/prd-06-living-cycle.md) — thread width is absolute, so a thick thread stays thick
...
done ([prd6 ruling 4](prds/done/prd-06-living-cycle.md)); brightness and traveling pulses are
...
ruling 3](prds/done/prd-04-human-facing.md)'s law 9a — hue is meaning, and each hue means one
...
(a lane keeps its angular slot for the session — [graft g7](prds/done/prd-03-viz-design-study.md)); and,
since [prd7](prds/done/prd-07-procedural-form.md) redrew every thread as a filled ribbon rather than a
...
rather than an organic one (a regression — [prd7 ruling 5](prds/done/prd-07-procedural-form.md) requires
...
has structurally replaced the attention strip ([ruling 16](prds/done/prd-03-viz-design-study.md): replay
...
glance. prd5 (`docs/prds/done/prd-05-beautiful-application.md`) added things to actually *do* with it, once
you're looking, and prd6 (`docs/prds/done/prd-06-living-cycle.md`) added two more — the root-mass
...
(since [prd7 ruling 3](prds/done/prd-07-procedural-form.md) — [prd6 ruling 2](prds/done/prd-06-living-cycle.md) is the fact,
unchanged) — the mass bulges gently where it arrives and settles back
([prd7 ruling 5](prds/done/prd-07-procedural-form.md)), the freed end springs back to its own node with
...
output**
([prd6 ruling 1](prds/done/prd-06-living-cycle.md): a lane that did more work leaves a visibly
...
them sent its work home into it ([prd6 ruling 2](prds/done/prd-06-living-cycle.md)) — you notice
...
and re-spacing the whole ring ([prd6 ruling 3](prds/done/prd-06-living-cycle.md)). There's no key to
...
([prd7 ruling 4](prds/done/prd-07-procedural-form.md)): each thread's gentle wander is seeded from a
...
- **A lane is parked:** ([prd4 ruling 5](prds/done/prd-04-human-facing.md)) it shows a dimmed `PARKED`
